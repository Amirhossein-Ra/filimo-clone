const SeriesImage = ({ active, reversedSeries, activeClicked }) => {
  return (
    <div className="w-full h-auto flex justify-center items-center flex-row gap-x-2 sm:justify-end lg:gap-x-[50px]">
      {reversedSeries?.map((elem) => {
        return (
          <div className="h-auto w-[165px]  relative" key={elem.id}>
            <img
